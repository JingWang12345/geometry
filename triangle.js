class Triangle{
    ...
    calculateArea(){
  const semiPerimeterMinusSegmentAB = this.calculateSemiPerimeter() - this.segmentAB.calculateLength();
  const semiPerimeterMinusSegmentBC = this.calculateSemiPerimeter() - this.segmentBC.calculateLength();
  const semiPerimeterMinusSegmentCA = this.calculateSemiPerimeter()- this.segmentCA.calculateLength();
  const product = this.calculateSemiPerimeter() * semiPerimeterMinusSegmentAB * semiPerimeterMinusSegmentBC* semiPerimeterMinusSegmentCA;
